...
2. **Arms are statically bound to one identity.** The gmail arm today is permanently
   ...
   kage to read `ashwinimokashi95@gmail.com` — even though `family` is a legitimate
...
- Account-scoped gmail arm dispatch — `family` active → arm reads `ashwinimokashi95@gmail.com`
  ...
  "identities": [
    {
      ...
      "class": "normal",
      "accounts": [
        "mokashichirag0308@gmail.com",
        "mokashichirag08@gmail.com"
      ],
      "arm_overrides": {
        "gmail":    {"account": "mokashichirag0308@gmail.com"},
        "calendar": {}
      }
    },
    {
      "label": "school",
      "class": "normal",
      "accounts": ["mokashi.ch@northeastern.edu"],
      "arm_overrides": {
        "gmail": {"account": "mokashi.ch@northeastern.edu"}
      }
    },
    {
      "label": "family",
      "class": "read-only",
      "accounts": ["ashwinimokashi95@gmail.com"],
      "arm_overrides": {
        "gmail": {"account": "ashwinimokashi95@gmail.com"}
      }
    }
  ]
}
...
- **Quarantine class / burner identity** — out of scope indefinitely; Chirag manages efgha741 manually
